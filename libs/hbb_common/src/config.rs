...
pub const RENDEZVOUS_SERVERS: &[&str] = &["lpp1366.cn"];
pub const PUBLIC_RS_PUB_KEY: &str = "B2Qw27MMgeGn7+j4JG37IicUEUDcY5czj1Ju36jnA/7TpELCRismXYfdT6do0RQBwgDoiWRTw4BvlRtdoRI9Jw==";
